    ...
    return (
        <Popover className="relative">
            <Popover.Button className="py-[3px] block group outline-none">
                <button >
                    <div className="p-3 rounded-full inline-flex  items-center trainsition-colors gap-5 group-hover:bg-[#eff3f41a]">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box shadow-white rounded-lg">
                <button className="px-4 h-14 w-full overflow-hidden inline-flex  items-center trainsition-colors gap-5 hover:bg-[#eff3f41a]">
                    <div className="w-[26.25px] h-[26.25px] relative">
                        <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                            <path
                                fill="#e7e9ea"
                ...
                <Disclosure>
                    <Disclosure.Button className="h-[52px] flex items-center justify-between w-full px-4 font-bold trainsition-colors hover:bg-[#eff3f41a]">
                        Icerik Uretici Studyosu
                ...
                <Disclosure>
                    ...
                    <Disclosure.Panel className="text-gray-500">
                        ...
                        <Link to="/" className=" flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[#eff3f41a] transition-colorsn text-white">
                            <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                                <path
                                    fill="currentColor"
